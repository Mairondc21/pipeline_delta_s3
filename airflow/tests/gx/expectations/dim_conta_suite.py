...
BUCKET = "s3a://mairon-pipeline-delta-s3-landing/silver/dim_conta"
...
suite_name = "dim_conta_suite"
lista_siites = [c.expectation_suite_name for c in context.list_expectation_suites()]

if suite_name not in lista_siites:
    context.add_expectation_suite(expectation_suite_name=suite_name)
else:
    print("ja existe carregando suite...")
...
batch_request = RuntimeBatchRequest(
    ...
    batch_identifiers={"run_id":"run_004"}
)
...
validator.expect_column_values_to_be_unique("conta_id")
